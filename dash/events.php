...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <?php foreach ($events as $event): ?>
        <div class="card p-6">
            <div class="aspect-video overflow-hidden rounded mb-4 bg-gray-200 dark:bg-gray-800">
            ...
            <form method="POST">
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        <button type="button" onclick="window.location.href='<?= ADMIN_PATH ?>/events.php'"
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-2 flex items-center gap-1">
                                        ...
                                        Create forms in <a href="<?= ADMIN_PATH ?>/forms.php"
