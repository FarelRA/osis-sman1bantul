...
<div id="editSubModal" class="hidden fixed inset-0 bg-gray-900/80 backdrop-blur-sm z-50 overflow-y-auto"
    onclick="if(event.target === this) SubmissionsManager.closeModal('editSubModal')">
        ...
        <div
            ...
            <form id="editSubForm">
                ...
                <div class="bg-blue-600 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                    <h3 class="text-lg sm:text-xl font-bold text-white">Edit Submission</h3>
                    <button type="button" onclick="SubmissionsManager.closeModal('editSubModal')"
                ...
                <div id="editSubFields" class="p-4 sm:p-6 space-y-4 max-h-[65vh] sm:max-h-[60vh] overflow-y-auto">
...
<!-- View Submission Modal (Read-only details) -->
<div id="viewSubModal" class="hidden fixed inset-0 bg-gray-900/80 backdrop-blur-sm z-50 overflow-y-auto"
    onclick="if(event.target === this) SubmissionsManager.closeModal('viewSubModal')">
    <div class="min-h-screen flex items-center justify-center p-2 sm:p-4">
        <div
            class="bg-white dark:bg-gray-800 w-full max-w-3xl rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden my-2 sm:my-4">
            <div class="bg-gray-700 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                <h3 class="text-lg sm:text-xl font-bold text-white">Submission Details</h3>
                <button type="button" onclick="SubmissionsManager.closeModal('viewSubModal')"
                    class="text-white/80 hover:text-white p-1">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M6 18L18 6M6 6l12 12" />
            ...
            <div id="viewSubContent" class="p-4 sm:p-6 max-h-[70vh] overflow-y-auto">
...
<div id="deleteConfirmModal"
    ...
    <div class="bg-white dark:bg-gray-800 w-full max-w-md rounded-xl shadow-2xl p-6">
        <div class="text-center">
            ...
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Delete Submission?</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">This action cannot be undone. The submission and
                all associated data will be permanently removed.</p>
            <div class="flex gap-3 justify-center">
                <button type="button" onclick="SubmissionsManager.closeModal('deleteConfirmModal')"
                    class="px-4 py-2.5 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-bold rounded-lg transition-colors text-sm">
                    Cancel
                </button>
